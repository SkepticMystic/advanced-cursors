...
class MyPlugin extends obsidian.Plugin {
    ...
    getCurrSelection(editor, content) {
        ...
        while (true) {
            ...
            iF++;
            if (nextF === null || nextF === void 0 ? void 0 : nextF.match(stops)) {
                fwdWord += nextF;
            }
            else
                break;
        ...
        while (true) {
            ...
            iB++;
            if (nextB === null || nextB === void 0 ? void 0 : nextB.match(stops)) {
                backWord += nextB;
            }
            else
                break;
