...
class CursorsModal extends obsidian.Modal {
    constructor(app, editor, plugin) {
        ...
        this.submit = (query, selection, offset, regexQ, flags = "") => {
            try {
                const selections = this.getSelectionsFromQuery(selection, offset, query, regexQ, flags);
    ...
    getSelectionsFromQuery(content, offset, query, regexQ, flags) {
        let regex;
        if (regexQ) {
